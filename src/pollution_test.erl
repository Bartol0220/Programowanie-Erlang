...
get_station_min_test() ->
  ...
  M3 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,12}}, "PM10", 9, M2),
  M4 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,13}}, "PM10", 8, M3),

  ?assertMatch(10, pollution:get_station_min("Stacja 1", "PM10", M2)),
  ?assertMatch(8, pollution:get_station_min({1,1}, "PM10", M4)),
  ?assertMatch(9, pollution:get_station_min("Stacja 1", "PM10", M3)).
...
get_closest_stations_test() ->
  M = pollution:add_station("Stacja 2", {3,3}, pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor())),
  M1 = pollution:add_station("Stacja 3", {2, 2}, M),
  M2 = pollution:add_station("Stacja 4", {2, 0}, M1),

  ?assertMatch(["Stacja 2"], pollution:get_closest_stations("Stacja 1", M)),
  ?assertMatch(["Stacja 1"], pollution:get_closest_stations("Stacja 2", M)),
  ?assertMatch(["Stacja 1"], pollution:get_closest_stations({1, 1}, M)),
  ?assertMatch(["Stacja 1"], pollution:get_closest_stations({1, 1}, M2)),
  ?assertMatch(["Stacja 3"], pollution:get_closest_stations("Stacja 1", M1)),
  ?assertMatch(["Stacja 4", "Stacja 3"], pollution:get_closest_stations("Stacja 1", M2)),
  ?assertMatch(["Stacja 2", "Stacja 1"], pollution:get_closest_stations("Stacja 3", M2)),
  ?assertMatch(["Stacja 4"], pollution:get_closest_stations({2, -2}, M2)).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
get_closest_stations_fail_test() ->
  M = pollution:create_monitor(),
  M1 = pollution:add_station("Stacja 2", {3,3}, pollution:add_station("Stacja 1", {1,1}, M)),
  M2 = pollution:add_station("Stacja 3", {2, 2}, M1),
  M3 = pollution:add_station("Stacja 4", {2, 0}, M2),

  ?assertMatch({error, _}, pollution:get_closest_stations("Stacja 1", M)),
  ?assertMatch({error, _}, pollution:get_closest_stations({1, 1}, M)),
  ?assertMatch({error, _}, pollution:get_closest_stations("Stacja 3", M1)),
  ?assertMatch({error, _}, pollution:get_closest_stations("Stacja 5", M3)).
